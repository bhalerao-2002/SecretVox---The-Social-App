						...
						<>
							<div className='flex gap-10 px-4 py-2 items-center'>
								...
								<div className='flex flex-col'>
									...
									<span className='text-sm text-slate-500'>{user?.postCount} Echoes</span>
								</div>
							</div>
							...
							<div className='flex flex-col gap-4 mt-14 px-4'>
									...
									{user?.link && (
										<div className='flex gap-1 items-center '>
											<>
												...
												<a
													href={user?.link.startsWith('http://') || user?.link.startsWith('https://') ? user.link : `http://${user.link}`}
													target='_blank'
													rel='noreferrer'
								...
								<div className='flex gap-2'>
									<div className='flex gap-1 items-center'>
										...
										<span className='text-slate-500 text-xs'>Associating</span>
									</div>
									<div className='flex gap-1 items-center'>
										<span className='font-bold text-xs'>{user?.followers.length}</span>
										<span className='text-slate-500 text-xs'>Associates</span>
									</div>
								</div>
							</div>
